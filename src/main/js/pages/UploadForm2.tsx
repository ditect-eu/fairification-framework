...
import {FormSchema} from "../objects/FormSchema";
...
export default class UploadForm2 extends React.Component<MyProps, UploadFormState> {
    ...
    render() {
        ...
        let schema: JSONSchema7 = FormSchema;
